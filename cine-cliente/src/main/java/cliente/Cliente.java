 ...
 */
 ...
 public class Cliente {
     ...
     private void generateTicket(String ticketInfo, String functionId, int seatNumber) {
         ...
         // Guardar el boleto en un archivo
         try (BufferedWriter writer = new BufferedWriter(new FileWriter(ticketId + ".txt"))) {
             writer.write(ticketContent);
             System.out.println("Ticket generated: " + ticketId + ".txt");
         } catch (IOException e) {
             e.printStackTrace();
         }
     }
